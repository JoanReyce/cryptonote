...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(171690000000000000);
...
const uint64_t DIFFICULTY_TARGET                             = 69; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "keyonix";
...
const int      P2P_DEFAULT_PORT                              = 17169;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 27169;
